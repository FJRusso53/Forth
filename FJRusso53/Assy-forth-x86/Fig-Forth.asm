...
PUSH $ + 10
JMP do_DOCOL
DD TIB, LIT, 32, WORD@, COUNT, FIND, NIP
DD SEMI
;
_TO:                        ; VERIFIED 231201
DD _TICK 
...
DD TICK, DUP@, EQU0
DD IF@
DD GCFA, LIT, 2, PLUS           ; CONVERT CFA TO NFA
DD NFA, LIT, 9, PLUS, STORE     ; SAVE IN NFA
DD THEN@
DD VALUESTORE
DD SEMI
;
