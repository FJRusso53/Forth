...
create msg9e z,"         Tracks each variable / definition for a maximum of 510 occurances"
...
2 0 do  cr 1 plines +!
	...
	if
	 1 do
	      ...
	      30 r> - 2 + spaces
	      dup Occurances w@ dup 4 .r 4 spaces
		...
		work-file-read
	      0 do
		  workfile-buffer i 2 * + dup c@ swap 1+ w@ swap
