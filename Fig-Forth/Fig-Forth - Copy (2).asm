...
Fig-Forth.asm
 FJRusso Vs 2.52  
 Sunday, January 14, 2024 8:36:44 AM  
...
NEXTC
@QS1:
MOV [SERROR+16], 23         ; stack underflow
NEXTC
@QS2:
MOV [SERROR+16], 24         ; stack overflow
NEXTC
;
...
DD SEMI
;
_SP:                            ; ( -- ADDR N)  EG S" TEXT TO HANDLE"    VERIFIED 240110
DD _DIVIDE
SP@:
DD do_SP
...
DB 256 DUP (0H) 
;
_MSGS DD _POC           ; MESSAGE ARRAY 25 ELEMENTS SIZE CELL (4)
MSGS DD do_DOVAR
DB 0, 4, 'MSG{'
DD 30 DUP (0H)
;
