...
JMP do_DOCOL
DD STATE, @
DD IF@, do_S_ADR, @                                         ; DETERMINES WHERE INPUT IS FROM
DD ELSE@, TIB
DD THEN@
DD LIT, 32, WORD@, COUNT
DD DUP2, UPPERCASE, DROP
...
DD LIT, 13, PARSE, DROP2   ; ASSUMES INPUT BUFFER HAS BEEN PLACED ON STACK             
DD SEMI
;
_COMMENT2:
DD _COMMENT1
