...
Include Ghost2023.h
\
\ GETADDR  ( addr1, size, count -- addr2 ) ( Returns Array element address )
\ mush faster access to data vs using DOES>
\
...
\
	['] psy{ psy-size + psy-size cns @ 1- * 0 fill	\ FJR 231021
\
((
 ms@ . 9 emit
  BEGIN              \ 2016aug29:
    cns @  1
  DO   \ 2016aug29: loop throughout "cns" memory.
  ...
  trc @  21  <
  WHILE  \ 2019-09-30: Cover 21 columns designated 0-20;
  REPEAT   \ 2016aug29:
 ms@ . cr
))
	['] ear{ ear-size + ear-size cns @ 1- * 0 fill	  	\ FJR 231021
((
...
:  .psy ( 2016JUL25: show concepts in the Psy array )
  ...
  t @ 1+  vault @
 DO  \ 2016aug24: show only from end of MindBoot "vault"
...
DO     \ 2016sep06: from 24jul14A.F MindForth
  ...
  IF                   \ 2016sep06: from old 24jul14A.F MindForth
      ...
      I 14 psy{  @  0 >
      IF  \ 2019-09-29: if there is a positive tkb value...
      ...
      psi20 @  vault @ <
      IF                  \ 2019-09-29: if longer than MindBoot...
          psi20 @  jrt @  20 psy{ !  0 I 20 psy{ !
      THEN  \ 2019-09-20
          psi20 @  coda @  vault @ +  >
       IF      \ 2019-09-29
...
\
['] psy{ psy-size T @ getaddr  ['] psy{ psy-size cns @ getaddr over - 0 Fill
((  cns @    t @
DO   \ 2016sep06: from old 24jul14A.F MindForth
...
:  SpreadAct  ( http://ai.neocities.org/SpreadAct.html )
  ...
  THEN  \ 2018-11-10: end of test for a positive "wherecon".
...
\ 120 10 min \ Self determining array sizes 10K set as initial size. Remove this line to use value calc above
\ to multiplier
\ 1024 multiplier * cns !
\
